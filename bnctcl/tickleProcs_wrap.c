...
#define SWIGTYPE_ptrdiff_t swig_types[0]
...
static int
_wrap_setisupport(ClientData clientData, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
    char *arg1 = (char *) 0 ;
    char *arg2 = (char *) 0 ;
    Tcl_DString ds_1 ;
    bool ds_use_1 = false ;
...
_wrap_internalsocketwriteln(ClientData clientData, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
    ...
    if (SWIG_GetArgs(interp, objc, objv,"io:internalsocketwriteln Socket Line ",&arg1,(void *)0) == TCL_ERROR) SWIG_fail;
    {
        ds_use_2 = true;
        arg2 = Tcl_UtfToExternalDString(g_Encoding, Tcl_GetString(objv[2]), -1, &ds_2);
    }
...
_wrap_internaltimer(ClientData clientData, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
    ...
    if (SWIG_GetArgs(interp, objc, objv,"ioo|o:internaltimer Interval Repeat Proc ?Parameter? ",&arg1,(void *)0,(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
...
static int
_wrap_impulse(ClientData clientData, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
    int arg1 ;
    char *result;
    
    if (SWIG_GetArgs(interp, objc, objv,"i:impulse imp ",&arg1) == TCL_ERROR) SWIG_fail;
    {
        try {
...
static int
_wrap_getallocinfo(ClientData clientData, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
    char *result;
    
    if (SWIG_GetArgs(interp, objc, objv,":getallocinfo ") == TCL_ERROR) SWIG_fail;
    {
        try {
            result = (char *)getallocinfo();
...
_wrap_control(ClientData clientData, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
    ...
    if (SWIG_GetArgs(interp, objc, objv,"io:control Socket Proc ",&arg1,(void *)0) == TCL_ERROR) SWIG_fail;
    {
        ds_use_2 = true;
        arg2 = Tcl_UtfToExternalDString(g_Encoding, Tcl_GetString(objv[2]), -1, &ds_2);
    }
